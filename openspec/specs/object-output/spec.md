# object-output Specification

## Purpose
TBD - created by archiving change add-artifact-object-output. Update Purpose after archive.
## Requirements
...
#### Scenario: Plugin S3 write

- **WHEN** the object_writer plugin is installed and credentials allow `PutObject`
