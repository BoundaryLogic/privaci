# ddl-phases Specification

## Purpose

Define pg_dump-style pre-data / data / post-data DDL phases for ``schema_mode:
replicate``, including trigger replication and DEFAULT/CHECK function hoist.
