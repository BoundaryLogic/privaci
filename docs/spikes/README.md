...
description: "Contributor validation notes for COPY-binary streaming, SpaCy throughput, and cyclic FK loads."
---

# Architecture benchmarks

These benchmarks validate core assumptions for the streaming and masking
architecture before changing production code paths.
...
| Topic | Document | Code |
|------|----------|------|
| COPY-binary round-trip | [2.1-copy-binary.md](2.1-copy-binary.md) | `privaci.spikes.copy_binary` |
| SpaCy throughput | [2.2-spacy-throughput.md](2.2-spacy-throughput.md) | `privaci.spikes.spacy_throughput` |
| Cyclic FK deferred | [2.3-cyclic-fk-deferred.md](2.3-cyclic-fk-deferred.md) | `privaci.spikes.cyclic_fk` |

> AWS Marketplace listing validation notes live in the private commercial
> repository (ADR-0007).

After running benchmarks locally, update the per-topic markdown files with your
