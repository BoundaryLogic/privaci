...
MATRIX_CELLS: tuple[MatrixCell, ...] = (
    ...
    MatrixCell(
        ...
        rank="P1",
        repo="public",
        label="CEL when: sandbox + capability + engine",
        axes={},
        capability_ids=("public-conditional-masking-cel",),
        triage_note="Conditional masking unit surface",
    ),
    MatrixCell(
        id="cel-when-pg",
        rank="P1",
        repo="public",
        label="CEL when: Postgres integration",
        axes={"schema_mode": "replicate"},
        capability_ids=("public-conditional-masking-cel-pg",),
        triage_note="Conditional masking live path",
    ),
    MatrixCell(
        id="pii-catalog-import-unit",
        rank="P2",
        repo="public",
        label="PII catalog import from DB comments",
        axes={},
        capability_ids=("public-pii-catalog-import",),
        triage_note="Comment heuristics + YAML models",
    ),
    MatrixCell(
